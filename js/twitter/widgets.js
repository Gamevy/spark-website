...
__twttrlr(function(using, provide, loadrunner, define) {
	...
	provide("util/logger", function(e) {
		...
		function a(e) {
			var t;
			if (!r) return;
			n[e] ? (t = f(), i("_twitter", e, t - n[e])) : o("timeEnd() called before time() for id: ", e)
		}
		function f() {
		...
		var t = ["con", "sole"].join(""),
			n = {},
			r = !! ~location.href.indexOf("tw_debug=true");
		e({
			info: i,
			warn: s,
			error: o,
	...
	provide("util/domready", function(e) {
		...
		function(e) {
			window.self != window.top ? t ? e() : n.push(e) : !
			function() {
				try {
					o.doScroll("left")
				} catch (t) {
		...
		using("util/domready", "util/env", "util/iframe", "util/promise", "util/util", function(t, n, r, i, s) {
			function u(e, t, n, o) {
				...
				this.readyPromise = new i(s.bind(function(e) {
					this.resolver = e
				}, this)), this.attrs = e || {}, this.styles = t || {}, this.appender = n ||
				function(e) {
	...
	provide("tfw/util/tracking", function(e) {
		using("dom/cookie", "dom/delegate", "sandbox/minimal", "util/donottrack", "util/promise", "util/querystring", "tfw/util/env", "util/iframe", "util/util", "$xd/json2.js", function(t, n, r, i, s, o, u, a, f) {
			...
			function H(e) {
				f.forIn(e, function(t) {~f.indexOf(c, t) && delete e[t]
				})
			}
			function B(e) {
	...
	provide("tfw/util/media", function(e) {
		using("dom/get", "util/util", "util/env", function(t, n, r) {
			function u(e, t) {
				return e == 2 || e == 3 && +t === 0
			}
			function a(e) {
				var t = e.split(" ");
				this.url = decodeURIComponent(n.trim(t[0])), this.width = +n.trim(t[1].replace(/w$/, ""))
			}
			function f(e, t, r) {
				var i, s, o, u;
				e = window.devicePixelRatio ? e * window.devicePixelRatio : e, s = n.map(t.split(","), function(e) {
					return new a(e)
				});
				if (r) for (u = 0; u < s.length; u++) s[u].url === r && (i = s[u]);
				return o = n.reduce(s, function(t, n) {
			...
			function l(e, t) {
				var n = e.getAttribute("data-srcset"),
					r = e.src,
					i;
				n && (i = f(t, n, r), e.src = i.url)
			}
			function c(e, t) {
				t = t || r.retina();
				if (!t) return;
				n.forEach(e.getElementsByTagName("IMG"), function(e) {
			...
			function h(e, r, a, f) {
				var c = 0,
					h = a ? 600 : 375,
					d = t.one("multi-photo", e, "DIV"),
					v = d && +d.getAttribute("data-photo-count");
				if (!e) return;
				return n.forEach(t.all("autosized-media", e), function(e) {
					var t = p(e.getAttribute("data-width"), e.getAttribute("data-height"), r, h);
					f(function() {
						l(e, r), e.width = t.width, e.height = t.height
					}), c = t.height > c ? t.height : c
				}), n.forEach(t.all("cropped-media", e, "IMG"), function(e) {
					var t = r - 12,
						n = e.parentNode,
						a = e.getAttribute("data-crop-x") || 0,
						d = e.getAttribute("data-crop-y") || 0,
						m, g, y = u(v, e.getAttribute("data-image-index")),
						b = Math.floor(t / 2 - i),
						w = Math.floor(b / (y ? s : o)),
						E;
					y || (w -= i / 2), E = p(e.getAttribute("data-width"), e.getAttribute("data-height"), b, h, b, w), m = E.width - b - a, g = E.height - w - d, m < 0 && Math.max(0, a += m), g < 0 && Math.max(0, d += g), f(function() {
						l(e, b), e.width = E.width, e.height = E.height, n.style.width = b - 1 + "px", n.style.height = w + "px", a && (e.style.marginLeft = "-" + Math.floor(E.width * a / 100) + "px"), d && (e.style.marginTop = "-" + Math.floor(E.height * d / 100) + "px")
					}), c = E.height * (y ? 2 : 1) > c ? E.height : c
				}), c
			}
	...
	provide("anim/transition", function(e) {
		function t(e, t) {
			var n;
			return t = t || window, n = t.requestAnimationFrame || t.webkitRequestAnimationFrame || t.mozRequestAnimationFrame || t.msRequestAnimationFrame || t.oRequestAnimationFrame ||
			function() {
	...
	provide("tfw/util/assets", function(e) {
		using("util/env", function(t) {
			...
			var n = {
				"embed/timeline.css": {
					"default": "embed/timeline.295a00bf5122128e332d25515711dbbd.default.css",
					"2x": "embed/timeline.295a00bf5122128e332d25515711dbbd.2x.css",
					gif: "embed/timeline.295a00bf5122128e332d25515711dbbd.gif.css",
					"default.rtl": "embed/timeline.295a00bf5122128e332d25515711dbbd.default.rtl.css",
					"2x.rtl": "embed/timeline.295a00bf5122128e332d25515711dbbd.2x.rtl.css",
					"gif.rtl": "embed/timeline.295a00bf5122128e332d25515711dbbd.gif.rtl.css"
				}
			};
			e(r)
		})
	...
	provide("tfw/widget/syndicatedbase", function(e) {
		using("tfw/widget/base", "tfw/widget/intent", "tfw/util/assets", "tfw/util/globals", "tfw/util/media", "tfw/util/tracking", "dom/classname", "dom/get", "dom/delegate", "sandbox/frame", "util/env", "util/promise", "util/twitter", "util/typevalidator", "util/util", function(t, n, r, i, s, o, u, a, f, l, c, h, p, d, v) {
			function T() {
				w = N.VALID_COLOR.test(i.val("widgets:link-color")) && RegExp.$1, S = N.VALID_COLOR.test(i.val("widgets:border-color")) && RegExp.$1, E = i.val("widgets:theme")
			}
			function N(e) {
				if (!e) return;
				var n;
				this.readyPromise = new h(v.bind(function(e) {
					this.readyResolver = e
				}, this)), this.renderedPromise = new h(v.bind(function(e) {
					this.renderResolver = e
				}, this)), t.apply(this, [e]), n = this.params(), this.targetEl = this.srcEl && this.srcEl.parentNode || n.targetEl || document.body, this.predefinedWidth = N.VALID_UNIT.test(n.width || this.attr("width")) && RegExp.$1, this.layout(v.bind(function() {
					return this.containerWidth = this.targetEl && this.targetEl.offsetWidth
				}, this)).then(v.bind(function(e) {
					var t = this.predefinedWidth || e || this.dimensions.DEFAULT_WIDTH;
					this.height = N.VALID_UNIT.test(n.height || this.attr("height")) && RegExp.$1, this.width = Math.max(this.dimensions.MIN_WIDTH, Math.min(t, this.dimensions.DEFAULT_WIDTH))
				}, this)), N.VALID_COLOR.test(n.linkColor || this.dataAttr("link-color")) ? this.linkColor = RegExp.$1 : this.linkColor = w, N.VALID_COLOR.test(n.borderColor || this.dataAttr("border-color")) ? this.borderColor = RegExp.$1 : this.borderColor = S, this.theme = n.theme || this.attr("data-theme") || E, this.theme = /(dark|light)/.test(this.theme) ? this.theme : "", this.classAttr.push(c.touch() ? "is-touch" : "not-touch"), c.ie9() && this.classAttr.push("ie9"), this.sandboxCreated = l.createSandbox({
				...
				}, this), this.layout).then(v.bind(function(e) {
					this.setupSandbox(e)
				}, this))
			}
			function C(e, t) {
			...
			var m = [".customisable", ".customisable:link", ".customisable:visited", ".customisable:hover", ".customisable:focus", ".customisable:active", ".customisable-highlight:hover", ".customisable-highlight:focus", "a:hover .customisable-highlight", "a:focus .customisable-highlight"],
				g = ["a:hover .ic-mask", "a:focus .ic-mask"],
				y = [".customisable-border"],
				b = [".timeline-header h1.summary", ".timeline-header h1.summary a:link", ".timeline-header h1.summary a:visited"],
				w, E, S, x = {
					TWEET: 0,
					RETWEET: 10
				};
			N.prototype = new t, v.aug(N.prototype, {
				setupSandbox: function(e) {
					this.sandbox = e, h.some(e.appendCss("body{display:none}"), e.setBaseTarget("_blank"), e.appendStyleSheet(twttr.widgets.config.assetUrl() + "/" + r("embed/timeline.css"))).then(v.bind(function() {
				...
				addSiteStyles: function() {
					var e = v.bind(function(e) {
						return (this.theme == "dark" ? ".thm-dark " : "") + e
					}, this),
						t = [];
					this.headingStyle && t.push(v.map(b, e).join(",") + "{" + this.headingStyle + "}"), this.linkColor && (t.push(v.map(m, e).join(",") + "{color:" + this.linkColor + "}"), t.push(v.map(g, e).join(",") + "{background-color:" + this.linkColor + "}")), this.borderColor && t.push(v.map(y, e).concat(this.theme == "dark" ? [".thm-dark.customisable-border"] : []).join(",") + "{border-color:" + this.borderColor + "}");
					if (!t.length) return;
					return this.sandbox.appendCss(t.join(""))
				},
				setNarrow: function() {
					var e = this.narrow;
					return this.narrow = this.width < this.dimensions.NARROW_WIDTH, e != this.narrow ? this.layout(v.bind(function() {
						return u.toggle(this.element, "var-narrow", this.narrow)
					}, this)) : h.fulfill(this.narrow)
				},
				bindIntentHandlers: function() {
					function r(n) {
						var r = a.ancestor(".tweet", this, t),
							i = v.aug({}, e.baseScribeData(), e.extractTweetScribeDetails(r));
					...
					f.delegate(t, "click", "A", r), f.delegate(t, "click", "BUTTON", r), f.delegate(t, "click", ".profile", function() {
						...
						if (c.ios() || c.android()) return;
						if (d.asBoolean(this.getAttribute("data-age-gate"))) return;
						r = p.intentForFollowURL(this.href, !0), r && (n.open(r, e.sandbox.element()), f.preventDefault(t))
				...
				collapseRegions: function() {
					v.forEach(a.all("collapsible-container", this.element), v.bind(function(e) {
						var t = e.children,
							n = t.length && e.offsetWidth,
							r = t.length && v.map(t, function(e) {
			...
			}), N.VALID_UNIT = /^([0-9]+)( ?px)?$/, N.VALID_COLOR = /^(#(?:[0-9a-f]{3}|[0-9a-f]{6}))$/i, T(), e(N)
		})
	});
			...
			q.prototype = new n, g.aug(q.prototype, {
				...
				getTweetDetails: function(e) {
					var t = w.one(L, e),
						...
						i, s, o = 0;
					n = t && t.children || [];
					for (; i = n[o]; o++) s = w.one(D, i, "A"), g.aug(r, this.extractTweetScribeDetails(i));
					return r
				},
				baseScribeData: function() {
					return {
				...
				requestTweets: function(e, t, n) {
					...
					t && this.cursors.maxPosition ? i.minPosition = this.cursors.maxPosition : !t && this.cursors.minPosition ? i.maxPosition = this.cursors.minPosition : t ? i.sinceId = e : i.maxId = e, i.complete = function() {
						...
						if (e && e.body !== undefined) {
							...
							l = r.getTweetDetails(s);
							for (c in l) l.hasOwnProperty(c) && u.push(c);
		...
		using("util/util", "tfw/widget/base", "util/querystring", "util/uri", "util/twitter", "util/promise", "dom/textsize", function(t, n, r, i, s, o, u) {
			...
			a.prototype = new n, t.aug(a.prototype, {
				...
				render: function(e, n) {
					...
					var r = twttr.widgets.config.assetUrl() + "/widgets/follow_button.1404859412.html#" + this.parameters(),
	...
	provide("tfw/widget/tweetbutton", function(e) {
		using("tfw/widget/base", "tfw/util/globals", "util/util", "util/querystring", "util/uri", "util/twitter", "util/typevalidator", "dom/textsize", function(t, n, r, i, s, o, u, a) {
			...
			p.prototype = new t, r.aug(p.prototype, {
				...
				render: function(e, t) {
					var n = twttr.widgets.config.assetUrl() + "/widgets/tweet_button.1404859412.html#" + this.parameters(),
						i;
	...
	function() {
		window.twttr = window.twttr || {}, twttr.host = twttr.host || "platform.twitter.com", using("util/domready", "util/env", "util/logger", function(e, t, n) {
			...
			twttr.init = !0, twttr._e = twttr._e || [], twttr.ready = twttr.ready ||
			function(e) {
